...
School library is an app that manages a Schools Library system with ruby programming language. It has a super class: Person with additional subclasses Student and Teacher that inherit from the Person class.
...
- **Module to check if student is of certain age**
- **Module to check for parent permisson**
...
- Clone this repository run git clone https://github.com/Log-benjamin/School-Library
Open the project in a text editor

- Run bundle install to install all project dependencies

- Press CTRL +  to run the project locally on terminal.
...
- [ ] **Add more classes for the App**
- [ ] **define the modules in each class with more functionality.**
